...
let elements_dic = {
  ...
  'head-title': {
    'en': 'We are SMART-UI',
    'de': 'Wir sind SMART-UI'
  },

  'head-sub': {
    'en': 'You deserve easy IT, to make it easy make it SMART 👋',
    'de': 'Sie verdienen einfache IT. Machen Sie es SMART 👋'
  },
  ...
  'popup-title': {
    ...
    'de': 'Hinterlasse deine Nachricht'
  },

  'popup-sub': {
    'en': 'Please leave one of your contacts to contact you.',
    'de': 'Bitte hinterlassen Sie einen Ihrer Kontakte, damit wir Sie kontaktieren können.'
  },

  'popup-field1': {
    'en': 'Leave any contacts: (telegram ,whatsapp, linkedin , etc...)',
    'de': 'Hinterlassen Sie alle Kontakte: (Telegram, WhatsApp, LinkedIn usw.)'
  },
  ...
  'popup-warn': {
    'en': 'Your data is safe and will not be passed on to third parties',
    'de': 'Ihre Daten sind sicher und werden nicht an Dritte weitergegeben'
  },
  ...
  'chat-sub': {
    'en': 'Last seen 5 minutes ago',
    'de': 'Zuletzt gesehen vor 5 Minuten'
  },
